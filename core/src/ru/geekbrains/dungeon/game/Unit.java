...
public abstract class Unit implements Poolable {
    ...
    public Unit(GameController gc, int cellX, int cellY, int hpMax) {
        ...
        this.attackSteps = MathUtils.random(1,4);
        this.moveSteps = MathUtils.random(1,4);
    }
    ...
    public void render(SpriteBatch batch, BitmapFont font18) {
        ...
        stringHelper.setLength(0);
        stringHelper.append("A "+attackSteps);
        font18.draw(batch, stringHelper, barX+40, barY+45, 60, 1, false);
        stringHelper.setLength(0);
        stringHelper.append("S "+moveSteps);
        font18.draw(batch, stringHelper, barX+40, barY+25, 60, 1, false);
